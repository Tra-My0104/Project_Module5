...
const Detailroom = () => {
  ...
  <form>
    <fieldset N="rating">
      ...
      <label N="star" for="star5" title="Rất tốt"></label>
      <input type="radio" id="star4" name="rating" value="4" />
      <label N="star" for="star4" title="Tốt"></label>
      <input type="radio" id="star3" name="rating" value="3" />
      <label N="star" for="star3" title="Bình thường"></label>
      <input type="radio" id="star2" name="rating" value="2" />
      <label N="star" for="star2" title="Kém"></label>
      <input type="radio" id="star1" name="rating" value="1" />
      <label N="star" for="star1" title="Rất kém"></label>
    </fieldset>
