...
function AdminHotel() {
  ...
  console.log('1',nameHotel)
  console.log('2',priceHotel)
  console.log('3',location)
  console.log('4',availability)
        ...
        <div className="ant-modal-wrap">
          ...
          >
            <div className="form-hotel">
              ...
              <br />
              <label>Giá</label> <br />
              <input className="form-control" type="number" value={priceHotel} onChange={(e) => setPriceHotel+(e.target.value)}/>
              <br />
