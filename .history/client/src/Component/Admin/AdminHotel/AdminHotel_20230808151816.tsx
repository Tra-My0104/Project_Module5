...
function AdminHotel() {
  ...
  const showEditModal = (id : number) => {
    const hotelToEdit = searchResults.find((hotel: Hotel) => hotel.hotel_Id === id);
  if (hotelToEdit) {
    ...
    <>
      <div className="container-adminHotel">
        ...
        >
              ...
              {searchResults?.length > 0 ? (
                searchResults.map((hotel: any, index: number) => (
                  <tr key={index}>
                    ...
                    <td>
                      <Button type="primary" ghost onClick={()=>showEditModal(hotel.hotel_Id)}>
                        <i
                      ...
                      >
                        <div className="form-hotel">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditHotelData({ ...editHotelData, nameRoom: e.target.value })
                            }
                          />
                          <br />
                          <label>Giá</label> <br />
                          <input
                            ...
                            onChange={(e) =>
                              setEditHotelData({ ...editHotelData, price: parseFloat(e.target.value) })
                            }
                          />
                          <br />
                          <label>Địa điểm</label> <br />
          ...
          >
            <Pagination
              current={currentPage} // Use the currentPage variable here
              pageSize={itemsPerPage}
              total={searchResults.length} // Use the length of searchResults for the total
