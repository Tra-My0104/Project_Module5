    ...
    <>
      <div className="container-adminHotel">
        ...
        <div className="ant-modal-wrap">
          <div> <Search placeholder="input search text" onSearch={onSearch} enterButton /></div>
       ...
       <div style={{display: 'flex', flexDirection: 'column', flex: 1, padding: '0 40px 0 20px'}}>
       <Table className="table" style={{width: '100%', }}>
          ...
          <tbody>
            {getCurrentPageData().map((hotel: any, index: number) => (
              <tr key={index}>
                <td>
                  <img
                    src={hotel.imgRoom}
                ...
                <td>
                  <Button type="primary" danger ghost onClick={() => handleDeleteHotel(hotel.hotel_Id)}>
                    <i
