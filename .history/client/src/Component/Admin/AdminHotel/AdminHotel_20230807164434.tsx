...
function AdminHotel() {
  ...
  const [newHotel, setNewHotel] = useState<CreateHotelDto>({
    imgRoom: "", // Set the appropriate initial values here
    nameRoom: "",
    price: 0,
    location: "",
    availability: "",
  ...
  const handleOk = async () => {
    try {
      ...
      // Set the newHotel object with the data from the state variables
      setNewHotel({
        imgRoom: "", // Set the appropriate values here
        nameRoom: nameHotel,
        price: priceHotel,
        location: location,
      ...
      // Send the POST request with the newHotel data
