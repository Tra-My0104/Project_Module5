...
function AdminHotel() {
  ...
  const [priceHotel , setPriceHotel] = useState<number>(0);
        ...
        <div className="ant-modal-wrap">
          ...
          >
            <div className="form-hotel">
              ...
              <br />
              <label>Tên</label> <br />
              <input className="form-control" type="text" value={nameHotel} onChange={() => setNameHotel(e.target.value)}/>
              <br />
              <label>Giá</label> <br />
              <input className="form-control" type="number" value={priceHotel} onChange={() => setPriceHotel(e.target.value)}/>
              <br />
