        ...
        <div className="ant-modal-wrap">
          ...
          >
            ...
            <label htmlFor="uploadMedia">
              ...
              <input className="form-control" type="text" value={nameRoom} onChange={(error) => setNameRoom(e.target.value)}/>
              <br />
              <label>Số người</label> <br />
              <input className="form-control" type="number" value={capacity} onChange={() => setCapacity(e.target.value)}/>
              <br />
              <label>Giá</label> <br />
              <input className="form-control" type="number" value={priceRoom} onChange={() => setPriceRoom(parseFloat(e.target.value))}/>
              <br />
              <label>Mô tả</label>
              <br />
