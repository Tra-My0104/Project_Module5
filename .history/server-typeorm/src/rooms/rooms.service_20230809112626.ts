...
export class RoomsService {
  ...
  async create(createRoomDto: CreateRoomDto, hotelId: number): Promise<Rooms> {
    const room = await this.roomsRepo.create({...createRoomDto, hotels: { hotel_id: hotelId }, // Thiết lập liên kết với khách sạn
    });
