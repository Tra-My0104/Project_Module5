...
export class RatetingService {
  ...
  async findRatetingsByHotelId(hotelId: number): Promise<Rateting[]> {
    return this.ratetingRepository
      .createQueryBuilder('rateting')
      .leftJoinAndSelect('rateting.hotel', 'hotel')
      .leftJoinAndSelect('rateting.user', 'user')
