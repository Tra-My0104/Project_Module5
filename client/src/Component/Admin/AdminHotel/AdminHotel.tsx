...
function AdminHotel() {
  ...
  const [currentImage, setCurrentImage] = useState<string>(""); // State để lưu trữ ảnh hiện tại
  ...
  const showEditModal = (id: number) => {
    const hotelToEdit = allHotel.find((hotel: Hotel) => hotel.hotel_Id === id);
    if (hotelToEdit) {
      setEditHotelData(hotelToEdit);
      setCurrentImage(hotelToEdit.imgRoom);
                      ...
                      >
                        <div className="form-hotel">
                          ...
                          <input
                            ...
                            onChange={handleAddMedia}
                          />
                          {currentImage && ( // Kiểm tra nếu có ảnh hiện tại thì hiển thị
                            <div>
